...
const catalogCourses = [
  ...
  { title: 'تجربة العميل', category: 'التواصل', duration: 'ساعتان', level: 'مبتدئ', price: '99 ر.س', image: '/images/checkpoint/business-team-preview.jpg' },
  { title: 'أساسيات التسويق الرقمي', category: 'التقنية', duration: '3 ساعات', level: 'مبتدئ', price: 'مجاني', image: '/images/checkpoint/course-data-preview.jpg' },
  { title: 'قيادة فرق العمل', category: 'القيادة', duration: '5 ساعات', level: 'متوسط', price: '179 ر.س', image: '/images/checkpoint/business-team-preview.jpg' },
];
