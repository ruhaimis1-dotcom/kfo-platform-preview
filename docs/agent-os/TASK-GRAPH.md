...
- D2 Company Training Dashboard visual preview: **PREPARED; awaiting Human Approval**. See `DESIGN-PREVIEW-CHECKPOINT-2.md` and `previews/COMPANY-TRAINING-DASHBOARD-D2.svg`. Do not implement the application route until the visual is approved.\n- D3 Employees & Teams, D4 Courses & Seats, D5 Training Assignment, D6 Reports & Certificates, D7 Orders & Invoices, D8 Company Settings: remain in the approved sequence and each requires Human Approval before implementation.
